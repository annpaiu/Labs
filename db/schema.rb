...
ActiveRecord::Schema[7.0].define(version: 2023_05_17_174209) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.integer "reader_card_id", default: 1, null: false
    t.index ["library_id"], name: "index_books_on_library_id"
    t.index ["reader_card_id"], name: "index_books_on_reader_card_id"
  end
  ...
  add_foreign_key "books", "reader_cards"
